...
const destinations = [
  ...
  },
  {
    ...
    description: 'Hel tigidhkaaga iyo QR code-ka gaarka kuu ah.',
    icon: FiCheckCircle,
  },
]
      ...
      <section className="py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
            <div>
              <h2 className="text-2xl font-bold text-gray-900 sm:text-3xl">Featured Events</h2>
              <p className="mt-2 text-gray-600">
                Halkan waxaad ka heli doontaa munaasabadaha la soo bandhigay.
              </p>
            </div>
            <a href="/events" className="font-semibold text-blue-600 hover:text-blue-700">
              View All Events
            </a>
          </div>
      ...
      <section id="how-it-works" className="bg-gray-50 py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 text-gray-600">
              Afar tallaabo oo fudud ayaa kuu dhexeeya munaasabadda iyo tigidhkaaga.
            </p>
          </div>
          ...
          <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:grid-cols-4">
            {steps.map((step, index) => {
              ...
              return (
                <article key={step.title} className="border-t-2 border-blue-600 bg-white p-5 shadow-sm">
                  <div className="flex items-center justify-between">
                    <Icon className="text-2xl text-blue-600" aria-hidden="true" />
      ...
      <section className="py-14 sm:py-16">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="rounded-lg border border-gray-200 bg-white p-6 shadow-sm sm:flex sm:items-center sm:justify-between sm:gap-8 sm:p-8">
            <div className="max-w-2xl">
              <h2 className="text-2xl font-bold text-gray-900">Ma qabanqaabisaa munaasabad?</h2>
              <p className="mt-2 leading-7 text-gray-600">
                EventHub wuxuu qabanqaabiyeyaasha ka caawiyaa abuurista iyo maareynta
                munaasabadaha iyo tigidhadooda hal meel.
              </p>
            </div>
            <button
              type="button"
              className="mt-6 w-full rounded-lg bg-blue-600 px-5 py-3 font-semibold text-white hover:bg-blue-700 sm:mt-0 sm:w-auto sm:shrink-0"
            >
              Become an Organizer
            </button>
          </div>
